...
This document outlines the preferred structure and pedagogical approach for courses within the LMDpro platform. It serves as a guideline for AI when generating new course outlines.

## 1. Hierarchy

Courses are organized as follows:
- **Field:** Broad subject area (e.g., Leadership & Management Fundamentals, Agile Business).
  - **Standalone Course:** A comprehensive course within a Field (e.g., Introduction to Modern Management).
    - **Sub-Course (Module):** Specific learning units within a Standalone Course (e.g., The Evolution of Management Thought).

## 2. Content Principles for Sub-Courses (Modules)

- **Clear Learning Objectives:** Each module should have 3-5 clear, actionable learning objectives.
- **Practical Application:** Emphasize real-world application, case studies, and examples.
- **Engaging Content:** Use a mix of text, conceptual images (if possible to suggest), and interactive elements (e.g., reflective questions).
- **Structured Sections:** Break down content into logical sections with clear headings.
- **Concise Overviews:** Each module, standalone course, and field should have a brief overview (1-3 sentences) summarizing its content and purpose.
- **Appropriate Difficulty and Length:** Clearly indicate estimated difficulty (Beginner, Intermediate, Advanced) and length (in hours or pages).

## 3. AI Generation Guidelines

When generating new course structures, the AI should:
- Propose relevant Field, Standalone Course, and Sub-Course titles based on the user's query.
- Generate concise overviews, difficulty levels, and estimated lengths for each component.
- For Sub-Courses, outline potential key topics or learning objectives that would typically be covered.
- Adhere to the file path conventions (e.g., `EducationalMaterial/Modules/module_title_slug.md`).
- Ensure generated content is distinct and offers a unique perspective if related to existing topics.
- Consider how the content might lend itself to various assessment types (as guided by `Assessment Structure.md`).
...
Difficulty: Beginner
Length: "Approximately 60-75 pages total"
Sub-Courses:
* Module: Introduction to Business & Management Principles
    ...
    * difficulty: Beginner
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_1_1_Quiz.md
* Module: Fundamentals of Professional Communication
    ...
    * difficulty: Beginner
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_1_2_Quiz.md
* Module: Basic Finance & Operations Concepts
    ...
    * difficulty: Beginner
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_1_3_Quiz.md
* Module: Introduction to Sales, Marketing & Customer Service
    ...
    * difficulty: Beginner
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_1_4_Quiz.md
* Module: Technology & Data in the Modern Workplace
    ...
    * difficulty: Beginner
    * length: "10-15 pages"
    * quizPath: EducationalMaterial/Assessments/Module_1_5_Quiz.md
...
Length: "Approximately 60-80 pages total"
Sub-Courses:
* Module: Effective Management & Leadership Styles
    ...
    * difficulty: Intermediate
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_2_1_Quiz.md
* Module: Business Communication & Negotiation
    ...
    * difficulty: Intermediate
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_2_2_Quiz.md
* Module: Financial Acumen & Operational Efficiency
    ...
    * difficulty: Intermediate
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_2_3_Quiz.md
* Module: Problem Solving & Decision Making
    ...
    * difficulty: Intermediate
    * length: "15-20 pages"
    * quizPath: EducationalMaterial/Assessments/Module_2_4_Quiz.md
...
Length: "Approximately 45-75 pages total"
...
Difficulty: Professional
Length: "Approximately 51-75 pages total"
...
Difficulty: Professional
Length: "Approximately 48-75 pages total"
...
Difficulty: Senior
Length: "Approximately 36-50+ pages total"
...
* Module: Scaling Agile & Lean Portfolio Management
    ...
    * difficulty: Senior
    * length: "18-25+ pages"
    * quizPath: EducationalMaterial/Assessments/Module_4_1_AB_Assessment.md
...
Difficulty: Senior
Length: "Approximately 36-50+ pages total"
assessmentPath: EducationalMaterial/Assessments/Level_4_CS_Exam.md # This exam was missing, adding it.
Sub-Courses:
...
Difficulty: Senior
Length: "Approximately 36-50+ pages total"
assessmentPath: EducationalMaterial/Assessments/Level_4_CY_Exam.md # This exam was missing, adding it.
Sub-Courses:
...
Difficulty: Senior
Length: "Approximately 36-50+ pages total"
assessmentPath: EducationalMaterial/Assessments/Level_4_DS_Exam.md # This exam was missing, adding it.
Sub-Courses:
...
* Module: Advanced Strategic Management & Innovation
    ...
    * difficulty: Senior
    * length: "18-25+ pages"
    * quizPath: EducationalMaterial/Assessments/01_Advanced_Strategic_Analysis_Frameworks_Quiz.md
* Module: Executive Decision Making & Crisis Leadership
    ...
    * difficulty: Senior
    * length: "18-25+ pages"
    * quizPath: EducationalMaterial/Assessments/02_Cognitive_Biases_in_Executive_Judgment_Quiz.md
...
* Module: Enterprise Agility & Business Transformation
    ...
    * difficulty: Executive
    * length: "20-25+ pages"
    * quizPath: EducationalMaterial/Assessments/01_Introduction_Extending_Agility_Across_the_Enterprise_Quiz.md # This seems like a quiz for L4, mapping here for now. Will need specific L5 quizzes.
...
* Module: Global Leadership & C-Suite Strategy
    ...
    * difficulty: Executive
    * length: "20-25+ pages"
    * quizPath: EducationalMaterial/Assessments/01_The_Global_Leadership_Imperative_Quiz.md
...
---
## Field: Technology_Development (Existing Field, with original Python course)
Field ID: TECH_DEV
...
---
## Field: AI_Specialization (New Field for AI Agent Modules)
Field ID: AI_SPEC
...
Difficulty: Advanced
Length: "Approximately 40-60 hours total" 
...
---
## Field: Leadership_and_Management_Fundamentals (Existing Field for Original Management Courses)
...
Length: 12 hours
Sub-Courses:
*   Sub-Course: The_Evolution_of_Management_Thought
    ...
    *   difficulty: Beginner
    *   length: "3 hours"
*   Sub-Course: Core_Management_Functions
    ...
    *   difficulty: Beginner
    *   length: "5 hours"
*   Sub-Course: Essential_Managerial_Skills
...
Length: 10 hours
Sub-Courses:
*   Sub-Course: Understanding_Leadership_Styles
    ...
    *   difficulty: Beginner
    *   length: "3 hours"
*   Sub-Course: Motivating_and_Engaging_Teams
    ...
    *   difficulty: Beginner
    *   length: "4 hours"
*   Sub-Course: Effective_Team_Communication
...
---
## Field: Agile_Business_and_Project_Management (Existing Field for original Agile/Lean courses)
Field ID: AGILE_PM
...
Length: 15 hours
Sub-Courses:
*   Sub-Course: Agile_Manifesto_and_Principles
    ...
    *   difficulty: Intermediate
    *   length: "3 hours"
*   Sub-Course: Scrum_Roles_and_Responsibilities
