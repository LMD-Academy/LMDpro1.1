    ...
    standaloneCourses: [
      {
        ...
        difficulty: "Beginner",
        length: "15-18 hours",
        assessmentPath: "EducationalMaterial/Assessments/Level_1_FBS_Exam.md", // Path to be created
        subCourses: [
  ...
  },
  {
    ...
    standaloneCourses: [
      ...
      { id: "DS_L3", title: "Data Science Specialization L3", overview: "Core Python data science libraries, data analysis, visualization, and an introduction to machine learning concepts and algorithms.", difficulty: "Professional", length: "20-25 hours", assessmentPath: "EducationalMaterial/Assessments/Level_3_DS_Exam.md", subCourses: [
        { id: "mod_3_1_ds", title: "Data Science Fundamentals & Python Programming", filePath: "EducationalMaterial/Modules/module_3_1_DS_content.md", overview: "Defines Data Science, its lifecycle, and key skills. Covers Python programming basics relevant to data science and introduces NumPy and Pandas for data manipulation.", difficulty: "Professional", length: "7-8 hours", language: "English", lessons: [] },
        { id: "mod_3_2_ds", title: "Data Analysis & Visualization", filePath: "EducationalMaterial/Modules/module_3_2_DS_content.md", overview: "Explores principles of Exploratory Data Analysis (EDA) using Pandas for data summarization and pattern discovery. Covers data visualization principles and use of Matplotlib and Seaborn.", difficulty: "Professional", length: "7-9 hours", language: "English", lessons: [] },
        { id: "mod_3_3_ds", title: "Introduction to Machine Learning", filePath: "EducationalMaterial/Modules/module_3_3_DS_content.md", overview: "Introduces Machine Learning concepts, types (supervised, unsupervised), and workflow. Implements basic algorithms like K-Nearest Neighbors, Linear Regression, and K-Means using Scikit-learn, and covers model evaluation.", difficulty: "Professional", length: "6-8 hours", language: "English", lessons: [] },
      ] },
      ...
      { id: "HR_L3", title: "Human Resources Specialization L3", overview: "Covers talent acquisition, performance management, employee development, employee relations, and labor law basics.", difficulty: "Professional", length: "23-28 hours", assessmentPath: "EducationalMaterial/Assessments/Level_3_HR_Exam.md", subCourses: [
        { id: "mod_3_1_hr", title: "Talent Acquisition & Management", filePath: "EducationalMaterial/Modules/module_3_1_HR_content.md", overview: "Details strategic workforce planning, job analysis and design, sourcing and recruitment strategies (including employer branding), structured interviewing and selection processes, onboarding best practices, and an introduction to talent management frameworks and succession planning.", difficulty: "Professional", length: "7-9 hours", language: "English", lessons: [] },
        { id: "mod_3_2_hr", title: "Performance Management & Employee Development", filePath: "EducationalMaterial/Modules/module_3_2_HR_content.md", overview: "Explores the performance management cycle, setting SMART goals, providing constructive feedback, various performance appraisal methods, managing underperformance, the importance of employee development and career planning, and different learning and development methodologies.", difficulty: "Professional", length: "7-9 hours", language: "English", lessons: [] },
        { id: "mod_3_3_hr", title: "Employee Relations & Labor Law Basics", filePath: "EducationalMaterial/Modules/module_3_3_HR_content.md", overview: "Focuses on principles of positive employee relations, managing workplace conflict, disciplinary procedures, grievances, fundamental concepts of labor law (discrimination, harassment, wage & hour, safety), DEI, and basics of collective bargaining.", difficulty: "Professional", length: "9-10 hours", language: "English", lessons: [] },
      ] },
  ...
  },
  {
    ...
    standaloneCourses: [
      ...
      { id: "DS_L4", title: "Data Science Advanced L4", overview: "Advanced machine learning, AI, Big Data technologies, and leveraging cloud platforms for data science.", difficulty: "Senior", length: "20-28 hours", assessmentPath: "EducationalMaterial/Assessments/Level_4_DS_Exam.md", subCourses: [
        { id: "mod_4_1_ds", title: "Advanced Machine Learning & AI", filePath: "EducationalMaterial/Modules/module_4_1_DS_content.md", overview: "Explores ensemble methods (Random Forests, Gradient Boosting), Support Vector Machines (SVMs), advanced unsupervised learning (DBSCAN, t-SNE), Deep Learning (ANNs, CNNs, RNNs, Transformers), Natural Language Processing (NLP) foundations, and Reinforcement Learning basics.", difficulty: "Senior", length: "10-14 hours", language: "English", lessons: [] },
      ] },
      ...
      { id: "HR_L4", title: "Human Resources Advanced L4", overview: "Strategic HR management, workforce planning, HR analytics, organizational development, and change leadership.", difficulty: "Senior", length: "20-28 hours", assessmentPath: "EducationalMaterial/Assessments/Level_4_HR_Exam.md", subCourses: [
        { id: "mod_4_1_hr", title: "Strategic HR Management & Workforce Planning", filePath: "EducationalMaterial/Modules/module_4_1_HR_content.md", overview: "Focuses on SHRM principles, advanced strategic workforce planning models, leveraging HR analytics for strategic decisions, managing talent systems, robust succession planning, building high-performance cultures, and HR's role in M&A.", difficulty: "Senior", length: "10-14 hours", language: "English", lessons: [] },
      ] },
  ...
  },
  {
    ...
    standaloneCourses: [
      ...
      { id: "CY_L5_CAP", title: "Cybersecurity Executive Capstone L5", overview: "Leading enterprise cybersecurity strategy, risk management, and fostering a security-aware culture from an executive perspective.", difficulty: "Executive", length: "20-30 hours", assessmentPath: "EducationalMaterial/Assessments/Level_5_CY_Assessment.md", subCourses: [
        { id: "mod_5_1_cy", title: "Executive Leadership in Cybersecurity & Risk Management", filePath: "EducationalMaterial/Modules/module_5_1_CY_content.md", overview: "Focuses on formulating enterprise cybersecurity strategy, designing resilient security architectures (e.g., Zero Trust), maturing security operations and incident response, integrating cyber risk with ERM, navigating global regulations, and communicating cyber risk effectively to the board.", difficulty: "Executive", length: "20-30 hours", language: "English", lessons: [] },
      ] },
  ...
  },
  {
    ...
    standaloneCourses: [
      ...
      { id: "LEAD_FOUND", title: "Foundations of Effective Leadership", overview: "Explores various leadership styles, motivational theories, team dynamics, and communication strategies for inspiring and guiding teams.", difficulty: "Beginner", length: "10 hours", assessmentPath: "EducationalMaterial/Assessments/Level_1_LEAD_Exam.md", subCourses: [
        { id: "lead_found_styles", title: "Understanding Leadership Styles", filePath: "EducationalMaterial/Modules/lead_found_styles.md", overview: "Introduces classical and contemporary leadership styles, Situational Leadership®, and the role of emotional intelligence.", difficulty: "Beginner", length: "3 hours", language: "English", lessons: [] },
        { id: "lead_found_motivation", title: "Motivating and Engaging Teams", filePath: "EducationalMaterial/Modules/lead_found_motivation.md", overview: "Covers key theories of motivation and provides practical strategies for creating an engaging team environment.", difficulty: "Beginner", length: "4 hours", language: "English", lessons: [] },
        { id: "lead_found_comm", title: "Effective Team Communication", filePath: "EducationalMaterial/Modules/lead_found_comm.md", overview: "Develops crucial team communication skills, including active listening, constructive feedback, and conflict resolution.", difficulty: "Beginner", length: "3 hours", language: "English", lessons: [] },
      ] },
    ]
  },
  {
    ...
    standaloneCourses: [
      { id: "AGILE_SCRUM", title: "Agile Project Management with Scrum", overview: "A comprehensive introduction to the Scrum framework, its roles, events, artifacts, and underlying principles for managing complex projects.", difficulty: "Intermediate", length: "15 hours", assessmentPath: "EducationalMaterial/Assessments/Level_2_AGILE_SCRUM_Exam.md", subCourses: [
        { id: "agile_scrum_manifesto", title: "Agile Manifesto and Principles", filePath: "EducationalMaterial/Modules/agile_scrum_manifesto.md", overview: "Explores the historical context, the four core values, and the twelve supporting principles of the Agile Manifesto.", difficulty: "Intermediate", length: "3 hours", language: "English", lessons: [] },
        { id: "agile_scrum_roles", title: "Scrum Roles and Responsibilities", filePath: "EducationalMaterial/Modules/agile_scrum_roles.md", overview: "Details the primary accountabilities of the Product Owner, Scrum Master, and Developers within the Scrum Team.", difficulty: "Intermediate", length: "4 hours", language: "English", lessons: [] },
        { id: "agile_scrum_events_artifacts", title: "Scrum Events and Artifacts", filePath: "EducationalMaterial/Modules/agile_scrum_events_artifacts.md", overview: "Covers the five Scrum events and the three official Scrum artifacts along with their commitments.", difficulty: "Intermediate", length: "5 hours", language: "English", lessons: [] },
        { id: "agile_scrum_user_stories", title: "User Story Writing and Estimation", filePath: "EducationalMaterial/Modules/agile_scrum_user_stories.md", overview: "Focuses on techniques for writing effective user stories, defining acceptance criteria, and relative estimation with story points.", difficulty: "Intermediate", length: "3 hours", language: "English", lessons: [] },
      ] },
