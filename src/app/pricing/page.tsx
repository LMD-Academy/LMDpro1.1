...
const tiers: SubscriptionTier[] = [
  ...
  },
  {
    ...
    name: "Teams",
    price: "$196",
    priceFrequency: "/month (for up to 5 users)",
    ...
    features: [
      ...
      { text: "Teams API Access (Enhanced Tier with higher limits)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Advanced Security Audits & Compliance Reporting (e.g., GDPR, CCPA)", included: true },
      { text: "Custom Branding, Whitelabeling & Content Authoring Tools", included: true },
      { text: "Enterprise API Access (Full, High Volume, Custom Endpoints)", included: true },
  ...
  },
   {
    ...
    features: [
      ...
      { text: "Resume Builder with Multiple Templates & PDF Export", included: true },
...
const featureComparison = [
    ...
    { category: "AI Agent Capabilities", feature: "Advanced Cognitive Processing (RAG)", community: "No", premium: "Yes", teams: "Yes", enterprise: "Enhanced RAG", nonprofit: "Basic RAG" },
    { category: "Content Creation", feature: "Video Creation (Script & 3D Animation)", community: "Basic (Watermarked)", premium: "Advanced (No Watermark, Avatars)", teams: "Collaborative + Brand Kits", enterprise: "Full Suite + API", nonprofit: "Watermarked (Educational)" },
    ...
    { category: "API & Admin", feature: "Developer API Access", community: "No", premium: "Developer Tier", teams: "Teams Tier (Higher Limits)", enterprise: "Full Enterprise Tier (Custom)", nonprofit: "Educational Projects Only" },
