...
import { ArrowRight, Zap, Star, Lightbulb, Film, FileText as FileTextIcon, GraduationCap, Briefcase, ShieldCheck, Handshake, BookOpen, DollarSign, HelpCircle, Settings, Link as LinkIconProp, Users as UsersIcon, Building, CheckCircle, UserCircle, FileVideo, ClipboardList, Library } from "lucide-react";
...
const pricingTiersHomepage = [
  { name: "Community", price: "Free", model: "Access to Latest Free AI Models", features: ["Limited Personalized Learning Paths", "Basic Video Creation (watermarked)", "1 Resume Template (watermarked export)", "Selection of Free Courses"], cta: "Join for Free", href:"/register?tier=community" },
  { name: "Premium", price: "$5.80/mo", model: "Access to Latest Flash AI Models", features: ["Unlimited Learning Paths & AI Generation", "Advanced Video Creation (No Watermark)", "All Resume Templates & AI Optimization", "Full Course Catalog Access"], cta: "Go Premium", href:"/register?tier=premium", popular: true },
  { name: "Teams", price: "$196/mo", model: "Access to Latest Pro AI Models", features: ["All Premium Features", "Team Management & Analytics", "Shared Resources & Brand Kits", "Consolidated Billing"], cta: "Choose Teams", href:"/register?tier=teams" },
];


const courseHighlights = [
  { id: "gm-l5-cap", title: "Executive Leadership Capstone L5", icon: GraduationCap, type: "Learning Path", description: "Lead global organizations and master C-suite strategy, large-scale transformation, and executive-level governance.", imageHint: "executive leadership team" },
  { id: "ai-agent-dev", title: "Autonomous AI Agent Development", icon: Zap, type: "Learning Path", description: "Comprehensive training from foundational AI principles to designing, building, and deploying advanced autonomous AI agents.", imageHint: "AI robot development" },
  { id: "ds-l3", title: "Data Science Specialization L3", icon: Briefcase, type: "Specialization", description: "Core Python data science libraries, data analysis, visualization, and an introduction to machine learning concepts and algorithms.", imageHint: "data science dashboard" },
];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {featureCards.map((feature, index) => (
                <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col overflow-hidden">
                   <div className="w-full h-48 relative">
                    <Image src={feature.imagePlaceholder} alt={feature.title} layout="fill" objectFit="cover" data-ai-hint={feature.imageHint} />
                    <div className={`absolute top-4 left-4 p-2 rounded-full ${feature.bgColor}`}>
                ...
                <Card key={index} className="shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden flex flex-col">
                  <div className="w-full h-48 relative bg-muted flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 bg-black/30 flex items-center justify-center p-4">
                        <course.icon className="h-12 w-12 text-white/80" />
                    </div>
                  </div>
                  <CardHeader>
                    <CardTitle className="font-headline text-xl">{course.title}</CardTitle>
                    <CardDescription className="text-sm h-16 overflow-hidden">{course.description} <span className="text-primary font-medium">({course.type})</span></CardDescription>
                  </CardHeader>
