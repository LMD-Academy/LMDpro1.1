...
const GoogleIcon = () => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5">
    <path fill="currentColor" d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.05 1.05-2.36 1.67-4.05 1.67-4.67 0-8.53-3.8-8.53-8.53s3.8-8.53 8.53-8.53c2.45 0 4.15.93 5.4 2.1l2.6-2.6C18.96 1.43 16.14 0 12.48 0 5.6 0 0 5.6 0 12.48s5.6 12.48 12.48 12.48c7.33 0 12.14-4.82 12.14-12.36 0-.8-.08-1.57-.2-2.32H12.48z" />
  </svg>
);
